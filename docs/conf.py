...
htmlhelp_basename = 'gantogdnsddoc'
...
latex_documents = [
  ('index', 'gantogdnsd.tex', u'ganto.gdnsd Ansible Role Documentation',
...
man_pages = [
    ('index', 'ganto.gdnsd', u'ganto.gdnsd Ansible Role Documentation',
     [u'Reto Gantenbein'], 1)
]
...
texinfo_documents = [
  ('index', 'gantogdnsd', u'ganto.gdnsd Ansible Role Documentation',
   u'Reto Gantenbein', 'gantogdnsd', 'One line description of project.',
   'Miscellaneous'),
]
